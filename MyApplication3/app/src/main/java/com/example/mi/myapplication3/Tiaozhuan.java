...
public class Tiaozhuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tiaozahun);
        ...
        tiaozhuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ComponentName componentName = new ComponentName("com.example.mi.myapplication4", "com.example.mi.myapplication4.MainActivity");
